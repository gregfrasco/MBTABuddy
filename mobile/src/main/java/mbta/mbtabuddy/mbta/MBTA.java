...
import mbta.mbtabuddy.mbta.mbtaAPI.Alert;
import mbta.mbtabuddy.mbta.mbtaAPI.AlertsByRoute;
import mbta.mbtabuddy.mbta.mbtaAPI.Direction;
import mbta.mbtabuddy.mbta.mbtaAPI.Mode;
import mbta.mbtabuddy.mbta.mbtaAPI.PredictionsByRoute;
import mbta.mbtabuddy.mbta.mbtaAPI.PredictionsByStop;
import mbta.mbtabuddy.mbta.mbtaAPI.PredictionsByTrip;
import mbta.mbtabuddy.mbta.mbtaAPI.Route;
import mbta.mbtabuddy.mbta.mbtaAPI.Routes;
import mbta.mbtabuddy.mbta.mbtaAPI.RoutesByStop;
import mbta.mbtabuddy.mbta.mbtaAPI.ScheduleByRoute;
import mbta.mbtabuddy.mbta.mbtaAPI.ScheduleByStop;
import mbta.mbtabuddy.mbta.mbtaAPI.ScheduleByTrip;
import mbta.mbtabuddy.mbta.mbtaAPI.StopsByLocation;
import mbta.mbtabuddy.mbta.mbtaAPI.StopsByRoute;
import mbta.mbtabuddy.mbta.mbtaAPI.Trip;
import mbta.mbtabuddy.mbta.mbtaAPI.Vehicle;
import mbta.mbtabuddy.mbta.mbtaAPI.VehiclesByRoute;
...
public class MBTA{
    ...
    public List<Stop> getAllStops(Station station, List<Line> lines) {
        List<Stop> stopIDs = new ArrayList<Stop>();
        for(Line line:lines){
            for(Stop stop:this.getStopsByRoute(line)){
                //if(station.getStationName().equals(stop.getParentStationName())){
                    //stopIDs.add(new Stop(stop.getStopId()));
                //}
            }
        }
        return stopIDs;
